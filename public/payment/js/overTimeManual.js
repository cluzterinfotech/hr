...
{   
   ...
   /*$('#OverTimeManualForm').validate({ 
   	rules: { 
   		   empIdOvertimeManual_combobox: { required: true },
           //overtimeDate:{ required:true},
  		   employeeNoNOHours: { required: true },
           employeeNoHOHours: { required: true },
           numberOfMeals: { required: true },
           month_combobox: { required: true },
           year_combobox: { required: true },
      }, 
      messages: { 
    	   empIdOvertimeManual_combobox: "please select employee",
           employeeNoHOHours:"please enter No. of holiday hours",
           employeeNoNOHours: "please enter No. of Normal hours",
           numberOfMeals: "please enter No. of Normal hours",
           month_combobox: "please select Month",
           year_combobox: "please select Year" 
      } 
   });*/ 
    
   $('#OverTimeManualForm').submit(function(e) {  
    	e.preventDefault(); 
    }).validate({ 
    	rules: { 
    		empIdOvertimeManual_combobox: { required: true },
       ...
       submitHandler: function(form) { 
            ...
            var formValues = {};
            var formArray = $("#OverTimeManualForm").serializeArray();  
            ...
            var request = $.ajax({ 
                url: "/overtimemanual/savemanualot", //view name
                type: "POST", 
                data: { 
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    function clearOverTimeManualForm()
    { 
    	$('#empIdOvertimeManual').val("");
    	$('#empIdOvertimeManual_combobox').val(""); 
    	$('#numberOfMeals').val(""); 
    ...
    function table() {
        $("#overtimeMContainer").zfTable('/overtimemanual/ajaxlist', {
            /*sendAdditionalParams: function() {
                var data = $('#OverTimeForm').serialize(); 
                return '&' + data;
            }*/ 
