        ...
        function initNavigation($obj){
            ...
            $obj.on('click', '.row-save', function(e){
                ...
                jQuery.ajax({ 
                    ...
                    type: 'POST',
                    success: function(data) {
                    	if($.trim(data.employeeNoNOHours)) {
                     	    $("#employeeNoNOHours").val(data.employeeNoNOHours);
                    	}
                    	if($.trim(data.employeeNoHOHours)) {
                    		$("#employeeNoHOHours").val(data.employeeNoHOHours);
                    	}
                    	if($.trim(data.numberOfMeals)) {
                    		$("#numberOfMeals").val(data.numberOfMeals);
                    	} 
                    },
                    dataType: 'json'
                }); 
