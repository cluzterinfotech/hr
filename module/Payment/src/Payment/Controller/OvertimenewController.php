...
class OvertimenewController extends AbstractActionController { 
    ...
    public function endorsehrallAction() {
        // real endorsement by HR through ajax
        $dateRange = $this->getDateRange(); 
        $this->getService()->endorseAllByHr($dateRange); 
        echo 1;
        //sleep(5); 
        exit;
    }
    
    public function endorsehrIndividualAction() {
