...
class AffectedallowanceController extends AbstractActionController {
	
	private $tableName = 'AllowanceAffectedAllowance'; 
	...
	public function ajaxlistAction() {
		...
		$grid->setAdapter($this->getDbAdapter())
		     ->setSource($this->getCompanyAllowanceService()
		     		          ->selectAllowanceAffectedAllowance()) 
	...
	private function getSiAllowanceGrid() {
		return new AffectedAllowanceGrid();
	}
