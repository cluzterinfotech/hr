...
class AllowancenottohaveController extends AbstractActionController {
	
	private $tableName = 'AllowanceNotToHaveAllowance'; 
	...
	public function ajaxlistAction() {
		...
		$grid->setAdapter($this->getDbAdapter())
		     ->setSource($this->getCompanyAllowanceService()
		     		          ->selectAllowanceNotToHaveAllowance()) 
	...
	private function getSiAllowanceGrid() {
		return new AllowanceNotToHaveGrid();
	}
