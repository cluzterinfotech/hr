...
class TravelLocalFormAdminApprovaListGrid extends AbstractTable {
	
	protected $config = array (
			'name' => 'Traveling Form Admin Approval List',
			'showPagination' => true,
	...
	protected function initFilters($query) {
		...
		$this->getHeader('edit')->getCell()->addDecorator('template', array(
				'template' => '<a href="/travelinglocal/approveadmin/%s" >Approve</a>',
				'vars' => array('id','id')
		)); 
