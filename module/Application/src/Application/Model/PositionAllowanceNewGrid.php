...
class PositionAllowanceNewGrid extends AbstractTable {
	
	protected $config = array (
			'name' => 'Position Allowance (Newly Added List)', 
			'showPagination' => true,
	...
	protected function initFilters($query) {
		...
		if ($value = $this->getParamAdapter()->getValueOfFilter('isUpdate')) {
			$query->where ( "isUpdate like '%" . $value . "%' " );
		} 
