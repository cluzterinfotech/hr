...
class TravelLocalFormApprovedListGrid extends AbstractTable {
	
	protected $config = array (
			'name' => 'Traveling Form Approved List',
			'showPagination' => true,
	...
	protected function initFilters($query) {
		...
		$this->getHeader('edit')->getCell()->addDecorator('template', array(
				'template' => '<a href="/travelinglocal/viewreport/%s" target="_blank">Report</a>',
				'vars' => array('id','id')
		)); 
		$this->getHeader('td')->getCell()->addDecorator('template', array(
				'template' => '<a href="/travelinglocal/viewreport/%s" target="_blank">Transport Details</a>',
				'vars' => array('id','id')
		));
