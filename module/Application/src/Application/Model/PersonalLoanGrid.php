...
class PersonalLoanGrid extends AbstractTable {
	
	protected $config = array (
			'name' => 'Personal Loan List',  
			'showPagination' => true,
	...
	protected function initFilters($query) {
		...
		$this->getHeader('remove')->getCell()
		     ->addDecorator('class', array('class' => 'removePersonalLoan'));  
