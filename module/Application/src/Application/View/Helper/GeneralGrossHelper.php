...
class GeneralGrossHelper extends AbstractHelper {
	...
	public function __invoke($name,$alllowance,$deduction,$companyDeduction,$results) {
		...
		$output = "<center>
		<h2>Oil Energy</h2>
		<h1 align='center'>&nbsp;General Gross</h1>"; 
		$output .= "<table width='400px' border='0' cellpadding='0'>
		<tr>
		<td colspan='2'><b>Name :".$results['employeeName']."</td>
		</tr>
		<tr>
		<td valign='top'><table width='400px' style='border-collapse: collapse' border='1' cellspacing='5px' cellpadding='2px'>"; 
