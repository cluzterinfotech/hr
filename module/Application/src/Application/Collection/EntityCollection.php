...
class EntityCollection implements EntityCollectionInterface {
	...
	public function offsetSet($key, $entity) {
		if (! $entity instanceof EntityInterface) {
			throw new \Exception ( "Could not add the entity to the collection.It is not instance of entity interface" );
		}
		if (! isset ( $key )) {
	...
	public function offsetExists($key) {
		return $key instanceof EntityInterface ? array_search ( $key, $this->entities ) : isset ( $this->entities [$key] );
	}
